...
<body>
	<h1 class="bgcolor1">
		<body onresize="parent.resizeTo(1920,1080)"
			...
			<FONT SIZE="8" FACE="Malgun Gothic"> 연성대학교 수강신청</FONT>
	...
	<form action="subreg" method="post">
		<span style="float: right"><input
			class="btn btn-sm btn-primary" name="logout" type="submit"
			value="로그아웃"> </span>
	</form>
		...
		<table class="data_tbl"
			...
			<thead>
				<tr>
					...
					<th rowspan="2" scope="col">수강신청</th>
				</tr>
			</thead>
			<tbody>
				<c:forEach var="item" items="${subbasketList}">
					<form action="subreg" method="post">
						<tr>
							<td><input type="text" value="${item.kmId}" name="regname"
							...
							<td><button type="submit" onclick="div1.reload"
									class="btn btn-sm btn-primary btn-block">신청</button></td>
						</tr>
					</form>
				</c:forEach>
			</tbody>
		...
		<table class="data_tbl"
			...
			<thead>
				<tr>
					...
					<th rowspan="2" scope="col">강의시간</th>
					<th rowspan="2" scope="col">교수명</th>
					<th rowspan="2" scope="col">신청인원</th>
					<th rowspan="2" scope="col">정원</th>
					<th rowspan="2" scope="col">이수구분</th>
					<th rowspan="2" scope="col">교과목수준</th>
					<th rowspan="2" scope="col">수강신청</th>
		...
		<table class="data_tbl"
			...
			<thead>
				<tr>
					...
					<th rowspan="2" scope="col">이수구분</th>
					<th rowspan="2" scope="col">교과목수준</th>
					<th rowspan="2" scope="col">수강취소</th>
				</tr>
			</thead>
			<tbody>
				<c:forEach var="item" items="${regList}">
					<form action="subreg" method="post">
						<tr>
							...
							<td><button type="submit"
									class="btn btn-sm btn-primary btn-block">취소</button></td>
						</tr>
					</form>
				</c:forEach>
			</tbody>
	...
	<script type="text/javascript">
		(function() {
			...
			<c:forEach var="result" items="${timeTable}"> // result 라는 이름으로 timeTable 세션의 리스트를 받아옴
